...
if (lMouseReleased && itemEquipped == Item.bow && itemAmmo > 0 && currentCooldown <= 0)
{ 
...
if (lMousePressed && itemEquipped == Item.bow && itemAmmo > 0 && currentCooldown <= 0)
{
	...
	if (lMouseAttackTimeActive <= 40)
	{
		...
		//ouseAttackTimeActiveRev = lMouseAttackTimeActive;
